...
<template>
  ...
  <div class="summary-wrapper" v-if="listing">
    <div class="oppsummert">{{ $t('checkout.inSummary') }}</div>
    ...
    <div class="content">
      ...
      <div class="content-wrapper">
        ...
        <div class="price-seller">
          {{ listing?.price }}kr
          <SellerInfo class="seller-info" :can-contact-seller="false" :user-id="listing!.ownerId" size="medium">
          </SellerInfo>
        </div>
      </div>
    </div>
